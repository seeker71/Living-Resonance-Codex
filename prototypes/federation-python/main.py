...
def show_available_demos():
    ...
    print("7. Interactive CLI Interface")
    print("0. Exit")
...
async def run_demo(demo_choice: str):
    ...
    try:
        if demo_choice == "1":
            ...
            print("Note: This will start a separate command-line interface.")
            print("Use 'quit' to return to this menu.")
            import subprocess
            subprocess.run(["python", "codex_cli.py"])
